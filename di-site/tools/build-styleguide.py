...
<p class="t-body">One row of the field: four identical objects, three columns each. The head carries two chips, the title and a two-line summary; the photograph sits under it and <b>slips --slip 20px up over it</b>. The head is quiet at rest and <b>fills with the card's hue under the pointer and on keyboard focus</b> — hover one — the control arrives with it, and the reader opens on that same hue. Where there is no hover (a touch screen) the hue is the resting state.</p>
...
<p class="t-body">See <a href="index.html" style="text-decoration:underline">index.html</a>: the header has no container at all — the wordmark on the left, the links, the theme toggle and Subscribe on the right, directly on the page at the field's gutter, and it scrolls away with the page. There is no Home link (the logo is the way home) and no Gallery link (the gallery is the hero). The foot of the page is one sky field holding the sign-up, the two contact links and the copyright.</p>
