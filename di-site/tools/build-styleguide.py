...
<p class="t-body"><b>Jost</b> — 800 for the display, 700 for titles — carries every heading; <b>Plus Jakarta Sans</b>, 400 and 600, carries everything else. Jost is a Futura, which is what the logo is drawn as: a perfectly circular bowl on a straight stem, one stroke weight, flat terminals, a single-storey <i>a</i>. One variable latin file, 25KB, every weight from 100 to 900. The body face is deliberately <i>not</i> geometric — a 0.460em x-height is a display face, not a reading one. Tracking tightens as size grows; leading loosens as it shrinks. Measures are in <code>em</code>, never <code>ch</code>.</p>
<div class="trow"><div class="tmeta"><b>display</b><br><span>hero title · Jost 800</span><br><code>.t-display</code></div><div class="t-display" style="max-width:none">New tools for cognitive development</div></div>
<div class="trow"><div class="tmeta"><b>h2</b><br><span>section titles · Jost 700</span><br><code>.t-h2</code></div><div class="t-h2" style="max-width:none">Safe, educational, and thrilling</div></div>
<div class="trow"><div class="tmeta"><b>h3</b><br><span>card titles · Jost 700</span><br><code>.t-h3</code></div><div class="t-h3">Creativity in motion creates knowledge!</div></div>
