...
6. **The closing field** — opens with the brand's own line at display scale, then the sign-up, the two contact links and the copyright, in one sky field inset by the gutter. It is the last thing anyone sees and it was a form and two links.
